...
@Controller
public class MiniNoeController {
    ...
    @GetMapping("/mininoe")
    public String devuelveMiniNoe(Model template, HttpSession sesion,
        ...
        if (categoria == null && color == null && precio == null) {
            ...
            template.addAttribute("miniNoe", "MINI NOE");
            ...
            template.addAttribute("categoria", categoria.replace("mini", ""));
            template.addAttribute("miniNoe", "miniNoe");
            template.addAttribute("items", items);
            template.addAttribute("nombreUsuario", sesion.getAttribute("u_nombreUsuario"));
